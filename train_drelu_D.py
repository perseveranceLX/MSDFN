...
def train(config):
    ...
    #dehaze_net.load_state_dict(torch.load("/home/amax/share/FGD/MSDFN/trained_model/outdoor/CUT_D_drelu-B/Epoch0.pth"))
    ...
    for epoch in range(0,config.num_epochs):
        ...
        with torch.no_grad():
            ...
            with open("trainlog/indoor/CUT_D_%s%s.log" % (config.lossfunc,config.actfuntion), "a+", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    if config.in_or_out == 'outdoor':
        ...
        config.snapshots_folder = "trained_model/outdoor/CUT_D_drelu-B/"
        config.sample_output_folder = "sample/outdoor/CUT_D_drelu-B"
