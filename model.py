...
class DEPTHV2(nn.Module):
    ...
    def forward(self,depth,image):
        ...
        """
        #----------深度图下卷积---------------------------------------------------------------------------------------------
        conv1_f = self.conv1_f(image)#原depth image,现在改为image输入用以对比
        ...
        #------------有雾彩色图下卷积----------------------------------------------------------------------------------------------
        conv1_input = self.conv1_input(image)
